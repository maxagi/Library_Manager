...
public:
	...
	bool						updateBook(const long &ISBN, const std::string& newVal, const int param);
	...
	void						reportBooksStatus(const std::string& title_or_isbn, const std::string& byWhat)const;



	bool						updateBorrowerName(const unsigned int ID, const std::string &newName);
	...
	void						reportOnAllBorrowers(const std::string& id_or_name, const std::string &byWhat)const;
